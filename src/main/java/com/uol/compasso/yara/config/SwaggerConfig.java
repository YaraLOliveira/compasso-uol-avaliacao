...
//                .tags(new Tag("ping", "Just a ping"))//
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder().title("Exemplo de projeto utilizando swagger")
                .title("Avaliação técnica compasso")
                ...
                .contact(new Contact("compasso"
                        , "https://compassouol.com/"
                        , "email@email.com"))
